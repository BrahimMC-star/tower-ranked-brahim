package zwuiix.colria.inventory.impl;
...
public class EntityInventory extends VirtualInventory {
    ...
    @Override
    protected DataPacket[] sendInventory(Player player, String name) {
        ...
        addEntity.id = "colria:virtual_chest";
        addEntity.type = 0;
        ...
        containerOpen.windowId = Byte.MIN_VALUE;
