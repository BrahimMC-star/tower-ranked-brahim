...
public class BanEntry {
    ...
    public BanEntry(String username, String reason, String staff, long createdAt, long expiresAt) {
    ...
    public static class Adapter implements JsonSerializer<BanEntry>, JsonDeserializer<BanEntry> {

        @Override
        public JsonElement serialize(BanEntry ban, Type type, JsonSerializationContext ctx) {
        ...
        @Override
        public BanEntry deserialize(JsonElement json, Type type, JsonDeserializationContext ctx) throws JsonParseException {
