...
public class BoosterAddSubCommand extends ColriaPlayerSubCommand {
    public BoosterAddSubCommand() {
        super("add");
    }
    ...
    public void execute(EnginePlayer player, Map<String, Object> args) {
        ...
        DB.getPlayerDataInfo(target).then(info -> {
            ...
            player.sendMessage(TranslationKeys.PLAYER_COMMAND_BOOSTER_ADD, amount, target);
