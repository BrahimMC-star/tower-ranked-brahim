...
public class BoosterRemoveSubCommand extends ColriaPlayerSubCommand {
    public BoosterRemoveSubCommand() {
        super("remove");
    }
    ...
    public void execute(EnginePlayer player, Map<String, Object> args) {
        ...
        DB.getPlayerDataInfo(target).then(info -> {
            info.increaseBooster(amount);
            player.sendMessage(TranslationKeys.PLAYER_COMMAND_BOOSTER_REMOVE, amount, target);
