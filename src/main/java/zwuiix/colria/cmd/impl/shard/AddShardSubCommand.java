...
public class AddShardSubCommand extends ColriaPlayerSubCommand {
    public AddShardSubCommand() {
        super("add");
    }
    ...
    public void execute(EnginePlayer player, Map<String, Object> args) {
        ...
        DB.getPlayerDataInfo(target).then(info -> {
            info.increaseShards(amount);
            player.sendMessage(TranslationKeys.PLAYER_COMMAND_SHARD_ADD, amount, target);
