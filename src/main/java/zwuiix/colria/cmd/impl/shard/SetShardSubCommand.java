...
public class SetShardSubCommand extends ColriaPlayerSubCommand {
    public SetShardSubCommand() {
        super("set");
    }
    ...
    public void execute(EnginePlayer player, Map<String, Object> args) {
        ...
        DB.getPlayerDataInfo(target).then(info -> {
            info.setShards(amount);
            player.sendMessage(TranslationKeys.PLAYER_COMMAND_SHARD_SET, amount, target);
