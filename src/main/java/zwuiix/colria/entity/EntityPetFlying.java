...
@Getter
@Setter
abstract public class EntityPetFlying extends EntityFlyingAnimal implements EntityRideable, EntityControllable, EntityClimateVariant, EntityPet {
    private Pet info;
    private EnginePlayer owner = null;
    private boolean saddled = false;

    public EntityPetFlying(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
    }
