...
@Getter
@Setter
abstract public class EntityPetWalking extends EntityWalkingAnimal implements EntityRideable, EntityControllable, EntityClimateVariant, EntityPet {
    private Pet info;
    private EnginePlayer owner = null;
    private boolean saddled = false;

    public EntityPetWalking(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
    }
