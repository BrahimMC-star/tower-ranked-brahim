...
public class EntityPetMagmaCube extends EntityPetJumping {
    public EntityPetMagmaCube(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
    }
    ...
    public void resetFallDistance() {
        ...
        this.getLevel().addSound(this, Sound.MOB_MAGMACUBE_JUMP, 0.5f, 1f);
    }
}
